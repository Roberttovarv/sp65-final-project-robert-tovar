              ...
              <>
                ...
                <div className="d-flex justify-content-center">
                  <ul className="list-group w-100" style={{ maxWidth: "100%" }}>
                    {games.map((item) => (
                      <li key={item.id} className="list-group-item mb-2 bg-white d-flex m-auto justify-content-center" style={{maxWidth: "60%"}}>
                        {
                            ...
                            currentGame && currentGame.id === item.id && (
                              <div className="w-100">
                                <div className="d-flex flex-wrap mb-3">
                                  <input type="text" value={`ID: ${currentGame.id}`} className="form-control me-2 mb-2" disabled style={{ maxWidth: "150px" }} />
                                  <input type="text" placeholder="Nombre" value={currentGame.name} className="form-control me-2 mb-2" style={{ flex: "1" }} onChange={(event) => setCurrentGame({ ...currentGame, name: event.target.value })} />
                                  <input type="text" placeholder="URL de Imagen" value={currentGame.background_image} className="form-control me-2 mb-2" style={{ maxWidth: "300px" }} onChange={(event) => setCurrentGame({ ...currentGame, background_image: event.target.value })} />
                                </div>
