...
export const PostsDetails = () => {
    ...
    const navigate = useNavigate(); // Corrige el uso de useNavigate
        ...
        <div className="row justify-content-center gamedet m-3">
            <div className="col-6">
                <div className="card tarjeta">
                    ...
                    <img src={store.currentItem.image_url} className="card-img-top" alt={store.currentItem.title} />
            ...
            <div className="input-container col-8 mt-5">
                <input
                    ...
                    onKeyDown={(e) => store.isLogin ? actions.sendPostComment(e) : navigate('/login-register')}
                />
                <label htmlFor="input-field" className="input-label ps-3 pt-3">Add comment</label>
